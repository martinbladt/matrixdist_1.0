...
//' 
// [[Rcpp::export]]
void EMstep_RK(double h, arma::vec & alpha, arma::mat & S, const Rcpp::NumericVector & obs, const Rcpp::NumericVector & weight, const Rcpp::NumericVector & rcens, const Rcpp::NumericVector & rcweight, bool erlang = false, Rcpp::IntegerVector merlang_blocks = Rcpp::IntegerVector(0)) {
  unsigned p{S.n_rows};
